...
const downBtn = document.querySelector('.down img');

document.querySelector('.down').addEventListener('mouseenter', () => {
  downBtn.src = './images/main/scroll_down_btn_hover.png';
});
document.querySelector('.down').addEventListener('mouseleave', () => {
  downBtn.src = './images/main/scroll_down_btn.png';
});